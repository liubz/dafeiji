...
var gameEngine={ele:null,allBullet:{},allEnemy:{},totalScore:0,init:function(){gameEngine.ele=document.getElementById("main");return this;},start:function(){console.log("开始游戏");gameEngine.loadding(function(){console.log("游戏加载完毕");myPlane.init().move();myPlane.fire();gameEngine.listeningKeybord();gameEngine.createEnemy();gameEngine.listeningCrash();gameEngine.moveBackground();});},loadding:function(callback){var logo=document.createElement("div");logo.className="logo";gameEngine.ele.appendChild(logo);var load=document.createElement("div");load.className="load";gameEngine.ele.appendChild(load);var imgs=["images2/loading1.png","images2/loading2.png","images2/loading3.png"];var i=0;var timer=setInterval(function(){if(i>=5){clearInterval(timer);gameEngine.ele.removeChild(logo);gameEngine.ele.removeChild(load);callback();}
